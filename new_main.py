...
meigen_text = canvas.create_text(90, 20, text="思考に気をつけなさい.テスト", fill="Green", font=("Times", 20, "bold"), width=450, anchor="nw")
...
start_button.place(x=500, y=20)
reste_botton = Button(text="停止", highlightthickness=0, font=(FONT_NAMA, 15, "bold"), fg=GREEN,)
reste_botton.place(x=500, y=50)
